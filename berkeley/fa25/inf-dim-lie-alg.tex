...
\begin{proposition}[Irreducibility and complete reducibility criteria]\label{prop:irred-crit}
...
\begin{definition}[Jantzen filtration]
...
\end{align*}
\begin{theorem}[Shapovalov determinant formula]
...
\begin{corollary}[Jantzen sum formula]
