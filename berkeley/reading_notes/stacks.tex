...
semistability follows from Propositions~\ref{prop:h0-semistability-equivalence-slope-semistability} and~\ref{h0-semistability-implies-gieseker-semistability}.
\end{enumerate}
\end{proof}
