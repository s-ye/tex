...
\begin{example}
	...
	The lattice polytope and fan look like \begin{center}
		\includegraphics[scale = .4]{/Users/songye03/Desktop/math_tex/img/rns.png}
	\end{center}
...
\begin{example}
	Consider the polytope and fan of the weighted projective space $\P(1,1,2)$ \begin{center}
		\includegraphics[scale = .4]{/Users/songye03/Desktop/math_tex/img/Screenshot 2024-02-18 at 10.42.28 PM.png}
	\end{center}
...
\begin{example}
	The lattice hexagon \begin{center}
		\includegraphics[scale = .4]{/Users/songye03/Desktop/math_tex/img/Screenshot 2024-02-18 at 11.21.48 PM.png}
...
\begin{example}
    Consider the fan of the simplex \begin{center}
        \includegraphics[scale = .4]{/Users/songye03/Desktop/math_tex/img/Screenshot 2024-02-18 at 11.47.48 PM.png}
    \end{center} 
